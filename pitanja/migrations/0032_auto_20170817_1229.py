# -*- coding: utf-8 -*-
# Generated by Django 1.11.2 on 2017-08-17 10:29
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('pitanja', '0031_auto_20170817_1214'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='Namena',
            field=models.CharField(choices=[('Складиштење просторних података', 'Складиштење просторних података'), ('Складиштење алфанумеричких података', 'Складиштење алфанумеричких података'), ('Остало', 'Остало')], max_length=100, null=True),
        ),
        migrations.AlterField(
